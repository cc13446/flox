...
const App: React.FC = () => {
    return (
        <div className="w-full h-16 border-2 flex flex-row justify-between items-center select-none">

            <div className="w-40 h-full pl-3 flex flex-row justify-between items-center select-none">
